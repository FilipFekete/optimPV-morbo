"""EmceeOptimizer module. This module contains the EmceeOptimizer class. The class is used to run MCMC Bayesian inference process using the emcee library."""
######### Package Imports #########################################################################

import emcee, corner, os, warnings
import numpy as np
